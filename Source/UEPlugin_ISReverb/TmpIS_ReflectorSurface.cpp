...
// Sets default values
ATmpIS_ReflectorSurface::ATmpIS_ReflectorSurface()
{
...
void ATmpIS_ReflectorSurface::BeginPlay()
{
	Super::BeginPlay();
	...
	_edges.Add(TmpIS_ReflectorEdge(_points[0], _points[1]));
	_edges.Add(TmpIS_ReflectorEdge(_points[1], _points[2]));
	_edges.Add(TmpIS_ReflectorEdge(_points[2], _points[3]));
	_edges.Add(TmpIS_ReflectorEdge(_points[3], _points[0]));
...
TArray<FVector3f> ATmpIS_ReflectorSurface::Points()
{
	return _points;
}

// Returns all edges of the surface polygon
TArray<TmpIS_ReflectorEdge> ATmpIS_ReflectorSurface::Edges()
{
	return _edges;
}
